...
class ViewModel {
  ...
  final Function(String, String, String, Announcement) onAddTask;
  final Function(Task) onRemoveTask;

  ViewModel({this.tasks, this.onAddTask, this.onRemoveTask});

  factory ViewModel.create(Store<TaskListState> store) {
    _onAddTask(String summary, String date, String dayOfWeek, Announcement announcement) {
      store.dispatch(AddTaskAction(summary, date, dayOfWeek, announcement));
    }
